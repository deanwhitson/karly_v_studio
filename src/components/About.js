...
const About = () => {
  ...
  return (
      ...
      <div className="container-content">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl">
              ...
              <div className="space-y-8">
                <h3 className="font-serif text-xl font-light text-charcoal mb-4">That process — from fragmentation to form — is where work happens. The aim isn't to provide answers. It's to explore things properly — and, in doing that, to make them feel a little more grounded.</h3>
                <p className="text-charcoal font-light tracking-[0.01em]">
    ...
    {/* New Test Section */}
    <section id="test" className="section-padding bg-warm-white">
      <div className="container-content">
        <div className="animate-on-scroll max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl">
            <div className="space-y-8">
              <h3 className="font-serif text-xl font-light text-charcoal mb-4">I'm Karly V — a musician, writer, and voice artist.</h3>
              <p className="text-charcoal font-light tracking-[0.01em]">
                add this following test in the about page: I'm Karly V — a musician, writer, and voice artist.
